...
#     def are_all_symbols_neww(self, items: Union[BaseItem, List[Any]]):
#         if not isinstance(items, list):
#             items = [items]

#         for item in items:
#             item._check_name(self.symbols)
...
#         # check if the path/name is ItemType.BOX
#         if name:
...
#             #     new_symbols = item._get_symbols()

#             #     if isinstance(item, BaseEdge):
#             #         for new_symbol in new_symbols:
#             #             str_new_symbol = str(new_symbol)
#             #             if not self.symbols.exists(str_new_symbol):
#             #                 raise ValueError(
#             #                     f"There is no variable '{str_new_symbol}'."
#             #                 )
#             #     else:  # Variable
#             #         str_new_symbol = str(new_symbols)
#             #         self.symbols.add(str_new_symbol, item.type)
#             #     model._add(item)
